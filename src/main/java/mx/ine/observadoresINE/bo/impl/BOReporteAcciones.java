...
public class BOReporteAcciones {
	...
	public DTOReportesParametros createTableParameters(DTOFiltroReporteAcciones datos, List<Object[]> data) {
		...
		case "OC":
			...
			if (datos.getTipoReporte().equals("L")) {
				dto.setTituloReporte("Acciones para promover la participación de los y las observadoras electorales por Entidad Federativa");
				dto.setColumnas(5);
			} else {
				dto.setTituloReporte("Acciones para promover la participación de los y las observadoras electorales por Entidad Federativa");
				dto.setColumnas(2);
		...
		case "JL":
			...
			dto.setEncabezado(obtenListaEncabezado(datos, dto));
			if (datos.getTipoReporte().equals("L")) {
				dto.setTituloReporte("Listado de acciones para promover la participación de observadoras y observadores electorales por distrito");
				dto.setColumnas(4);
			} else {
				dto.setTituloReporte("Concentrado de acciones para promover la participación de observadoras y observadores electorales por distrito");
				dto.setColumnas(2);
			}
			break;
		case "JD":
			dto.setTituloReporte("Listado de acciones para promover la participación observadoras y observadores electorales por Distrito");
			dto.setColumnas(3);
			dto.setEncabezado(obtenListaEncabezado(datos, dto));
			break;
		}
