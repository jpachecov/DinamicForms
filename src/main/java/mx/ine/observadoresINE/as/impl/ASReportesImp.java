...
public class ASReportesImp implements ASReportesInterface {
    ...
    public List<Object[]> consultarEncabezadoCanDenDecl(FormRepControlObs form)throws ApplicationException {
        ...
        try {
               encabezado = daoReportes.consultarEncabezadoCanDenDecl(form);
        } catch (Exception e) {
            LOGGER.error("[Error]: ASReportesImp.consultarEncabezadoCanDenDecl()- ", e);
			throw new ApplicationException(Utilidades.mensajeProperties("mensaje_error_generacion_reportes"),
                                  Constantes.CODIGO_EXEPTION);
        }
        return encabezado;
     ...
     */
    @Override
    public List<Object[]> consultarRepAcreditacionesNoAprobadasPorEntidad(FormRepControlObs form) throws ApplicationException {
        List<Object[]> encabezado;
        try {
               encabezado = daoReportes.consultarRepAcreditacionesNoAprobadasPorEntidad(form);
        } catch (Exception e) {
            LOGGER.error("[Error]: ASReportesImp.consultarRepAcreditacionesNoAprobadasPorEntidad()- ", e);
			throw new ApplicationException(Utilidades.mensajeProperties("mensaje_error_generacion_reportes"),
                                  Constantes.CODIGO_EXEPTION);
        }
        return encabezado;
