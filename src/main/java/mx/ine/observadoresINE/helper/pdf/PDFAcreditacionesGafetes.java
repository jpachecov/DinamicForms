...
public class PDFAcreditacionesGafetes extends PdfPageEventHelper{
	...
	//			       se agrega el logo en el gafete
				       ...
				       if(filtro.getAmbito().equalsIgnoreCase("F") || filtro.getAmbito().equalsIgnoreCase("C")){
				    	   template.showTextAligned(PdfContentByte.ALIGN_CENTER, textoAcreditacion.substring(0,textoAcreditacion.length()-21).trim(), 60, 104.5f, 0);
				       }else {
				       ...
				       template.setFontAndSize(bfBold, 4);
				       if(filtro.getAmbito().equalsIgnoreCase("F") || filtro.getAmbito().equalsIgnoreCase("C")){
				    	   template.showTextAligned(PdfContentByte.ALIGN_CENTER, textoAcreditacion.substring(textoAcreditacion.length()-21, textoAcreditacion.length()).trim(), 60, 98F, 0);
				       }else {
				       ...
				       String consejero = "";
				       if(r.getIdJustificacion() != null && r.getIdJustificacion() == 2){
	...
	//	   			   se agrega el template a la celda
		   			   ...
		   			   if(r.getVocalSecretarioD() != " " && r.getVocalPresidenteD() == " "){
		   				   ...
		   				   }else if(r.getIdJustificacion() == 2){	
