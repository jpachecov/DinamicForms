...
public class HLPReporteDetalleObservadores implements Serializable{
	...
	public HLPReporteDetalleObservadores (Integer nivelOficinas, List<Object[]> listaDatos){
		...
		switch(nivelOficinas){
			case 1:
				this.tituloReporte = "Reporte detalle de observadores registrados OC";
				crearEncabezado();
				break;
			case 2:
				this.tituloReporte = "Reporte detalle de observadores registrados JL";
				crearEncabezado();
				break;
			case 3:
				this.tituloReporte = "Reporte detalle de observadores registrados JD";
				crearEncabezado();
				break;
		}
	}
	...
	public void crearEncabezado(){
		this.columnas = 11;
		this.listaEncabezados = new ArrayList<>();;
		...
		hlpEncabezado.ingresarEncabezado(3, 1, 1, "Sexo", 1);
		...
		hlpEncabezado.ingresarEncabezado(7, 1, 1, "Estatus de acreditaci\u00f3n", 1);
		hlpEncabezado.ingresarEncabezado(8, 1, 1, "Curso", 1);
		hlpEncabezado.ingresarEncabezado(9, 1, 1, "Fecha de sesi\u00f3n", 1);
