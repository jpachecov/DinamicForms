...
public class BSDConfiguracionCatalogosImpl implements
	...
	public void guardaActualizaReglasEvaluacion(
		...
		asConfiguracionCatalogos.guardaActualizaReglasEvaluacion(reglasEvaluacion);
	...
	public void eliminaReglasEvaluacion(
		...
		asConfiguracionCatalogos.eliminaReglasEvaluacion(reglasEvaluacion);
	...
	public List<DTOReglasEvalucaion> getReglasEvaluacion(Integer idProceso,
		...
		return asConfiguracionCatalogos.getReglasEvaluacion(idProceso, idDetalle, idEvaluacion);
	}
