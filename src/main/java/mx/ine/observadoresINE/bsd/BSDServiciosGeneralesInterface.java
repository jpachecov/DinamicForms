 ...
 *
 */
public interface BSDServiciosGeneralesInterface {
	 ...
	 * 
	 * @param idEstado
	 *            - EL id del estado del que se requieren sus municipios.
	 * @param ambito
	 *            - Ambito Local o Federal. En el NUEVO GEOGRAFICO sólo Federal.
	 * @return
	 * @throws Exception
	 */
