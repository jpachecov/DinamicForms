...
public interface DAOReportesInterface {
    ...
    /**
     * Método que consulta el catálogo C_Justificaciones y obtiene los aprobados
     *
     * @author Helaine Flores C.
     * @param form
     * @since 24/08/2017
     ...
     * @return
     */
    List<Object[]> consultarEncabezadoCanDenDecl(FormRepControlObs form);
    /**
     * Método que consulta el reporte "Acreditaciones No aprobadas Por Entidad OC"
     * @param form
     * @return 
     */
    List<Object[]> consultarRepAcreditacionesNoAprobadasPorEntidad(FormRepControlObs form);
